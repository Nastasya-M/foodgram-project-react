# Generated by Django 3.2 on 2023-05-14 09:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(choices=[('#FFA500', 'Оранжевый'), ('#008000', 'Зеленый'), ('#FFFF00', 'Желтый'), ('#0000FF', 'Синий')], default='#0000FF', image_field=None, max_length=7, samples=None, unique=True, verbose_name='Цвет')),
